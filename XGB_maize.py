...
data_silage_maize = pd.read_csv('C:/Users/asalr/OneDrive/Escritorio/thesis/final DATA/silage maize/data_silage_maize.csv', sep=',')
...
plt.savefig(r'C:\Users\asalr\OneDrive\Escritorio\New folder\rr.jpg', bbox_inches = 'tight', dpi=600)
plt.show()
...
#fig.savefig(r'C:\Users\asalr\OneDrive\Escritorio\New folder\ttfr.jpg', dpi=600)
...
plt.savefig(r'C:\Users\asalr\OneDrive\Escritorio\New folder\partial.png', dpi=600)
plt.show()
