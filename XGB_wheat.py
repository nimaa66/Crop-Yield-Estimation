...
data_silage_maize = pd.read_csv(r'C:\Users\asalr\OneDrive\Escritorio\thesis\final DATA\winter wheat\data_winter_wheat.csv', sep=',')
...
#               }
# =============================================================================
param_grid = {'n_estimators': [900, 1000, 1050, 1150],
...
plt.savefig(r'C:\Users\asalr\OneDrive\Escritorio\winter wheat\rr.jpg', bbox_inches = 'tight', dpi=600)
plt.show()
...
fig.savefig(r'C:\Users\asalr\OneDrive\Escritorio\winter wheat\ttfr.jpg', dpi=600)
...
features = [('NDWI_June_4', 'LST_June_1')]
plt.figure(figsize=(10, 8))
PartialDependenceDisplay.from_estimator(best_grid, X_train, features)
plt.xlabel('NDWI_June_4', fontsize=14)    # Adjusting x-axis label font size
plt.ylabel('LST_June_1', fontsize=14)    # Adjusting y-axis label font size
...
plt.savefig(r'C:\Users\asalr\OneDrive\Escritorio\winter wheat\partial.png', dpi=600)
plt.show()
