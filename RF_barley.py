...
data_silage_maize = pd.read_csv(r'C:\Users\nimam\OneDrive\Desktop\ZALF THESIS\final DATA\winter barley\data_winter_barley.csv', sep=',')
...
param_grid = {
    ...
    'n_estimators': [1850, 1950, 2000, 2050]
}
...
plt.savefig(r'C:\Users\nimam\OneDrive\Desktop\result barley\rr.png', bbox_inches = 'tight', dpi=600)
plt.show()
...
ax[3, 0].set_xlabel('Counties Codes') #this line should be in the last plot.
...
fig.savefig(r'C:\Users\nimam\OneDrive\Desktop\result barley\rrcssd.png', dpi=600)
...
plt.savefig(r'C:\Users\nimam\OneDrive\Desktop\result barley\partial.png', dpi=600)
plt.show()
